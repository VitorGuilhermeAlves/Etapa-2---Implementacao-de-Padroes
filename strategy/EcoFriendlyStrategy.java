...
class EcoFriendlyStrategy extends RouteStrategy{
  private double km_price = 0.8;
  private double trasnport_price = 1.65;

  private double trafic_time = 30;
  private double km_time = 0.20;
  private double climate_time = 20;
  ...
  public void calculateRoute(String origin, String Target){
    ...
    System.out.println("Calculating ecoFriendlyRoute from " + origin + " to " + Target + "...");
